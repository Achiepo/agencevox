    ...
    <footer className="bg-gray-900 text-white py-12 animate-fade-in">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-semibold mb-4">VoyageXplore</h3>
          ...
          <div>
            <h3 className="text-xl font-semibold mb-4">Nos Bureaux</h3>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} VoyageXplore. Tous droits réservés.</p>
        </div>
      </div>
    </footer>
  );
